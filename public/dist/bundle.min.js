    ...
    _createClass(Gallery, [{
      ...
      value: function showImage() {
        ...
        if (cImage.media === 'video') {
          ...
          img.addEventListener('canplay', function (event) {
            return _this7._onImageLoad(event);
          });
  ...
  var Canvas = /*#__PURE__*/function (_Gallery) {
    ...
    _createClass(Canvas, [{
      ...
      value: function drawImage() {
        var _canvas$bitmap;
        var slot = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
        var scale = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
        var canvas = this.img[slot];
        var context = canvas.getContext('2d');
        var image = (_canvas$bitmap = canvas.bitmap) !== null && _canvas$bitmap !== void 0 ? _canvas$bitmap : canvas.image;
      ...
      value: function showImage(cImage, src) {
        ...
        */
        ...
        image.onload = function (canvas) {
          var style = _this.get('imgStyle');
          var width = _this.canvasContainer.clientWidth;
          var height = _this.canvasContainer.clientHeight;
          width = width * image.height / image.width <= height || style.objectFit === 'cover' ? width : height * image.width / image.height;
          height = width / image.width * image.height;
