...
(function () {
    ...
    _createClass(Gallery, [{
      ...
      value: function removeEventListeners() {
        ...
        document.removeEventListener('mousemove', function (event) {
          return _this3.dispatchEvent('MouseMove', event);
        });
        document.removeEventListener('keyup', function (event) {
          return _this3.dispatchEvent('KeyUp', event);
        });
        document.removeEventListener('keydown', function (event) {
          return _this3.dispatchEvent('KeyDown', event);
        });
        window.removeEventListener('resize', function (event) {
          return _this3.dispatchEvent('Resize', event);
        });
        window.removeEventListener("orientationchange", function (event) {
          return _this3.dispatchEvent('Resize', event);
        });
        window.removeEventListener("offline", function (event) {
          return _this3.dispatchEvent('Offline', event);
        });
        window.removeEventListener("online", function (event) {
          return _this3.dispatchEvent('Online', event);
        });
      }
    }, {
      ...
      value: function addEventListeners() {
        ...
        document.addEventListener('mousemove', function (event) {
          return _this4.dispatchEvent('MouseMove', event);
        });
        document.addEventListener('keyup', function (event) {
          return _this4.dispatchEvent('KeyUp', event);
        });
        document.addEventListener('keydown', function (event) {
          return _this4.dispatchEvent('KeyDown', event);
        });
        window.addEventListener('resize', function (event) {
          return _this4.dispatchEvent('Resize', event);
        });
        window.addEventListener("orientationchange", function (event) {
          return _this4.dispatchEvent('Resize', event);
        });
        window.addEventListener("offline", function (event) {
          return _this4.dispatchEvent('Offline', event);
        });
        window.addEventListener("online", function (event) {
          return _this4.dispatchEvent('Online', event);
        });
      }
    }, {
      key: "navigate",
            ...
            while (1) switch (_context.prev = _context.next) {
              case 0:
                ...
                return _context.abrupt("return", fetch(filename).then(function (response) {
                  ...
                  _this6.dispatchEvent('Error', undefined, error);
                }));
              case 2:
              case "end":
      ...
      value: function dispatchEvent(eventName) {
        ...
        if (typeof this.onEvent === 'function') {
          this.onEvent.apply(this, [eventName].concat(args));
        }
        if (typeof this[internalCallbackName] === 'function') {
          this[internalCallbackName].apply(this, args);
        }
        ...
        if (value === true) {
          if (this.transitionFrame && !this.isPaused()) {
            this.afterTransition = function () {
              return _this7.dispatchEvent("PauseStart");
            };
  ...
  var Sandwich = /*#__PURE__*/function (_HTMLElement) {
    ...
    function Sandwich() {
      var _this$attributes$quer, _this$attributes$hide, _this$attributes$acti, _this$attributes$butt, _this$attributes$menu;
      var _this;
      ...
      _this.menu = menu;
      _this.queryParam = ((_this$attributes$quer = _this.attributes.queryParam) === null || _this$attributes$quer === void 0 ? void 0 : _this$attributes$quer.value) || _this.queryParam || 'page';
      _this.hideClass = ((_this$attributes$hide = _this.attributes.hideClass) === null || _this$attributes$hide === void 0 ? void 0 : _this$attributes$hide.value) || _this.hideClass || 'hide';
      _this.activeClass = ((_this$attributes$acti = _this.attributes.activeClass) === null || _this$attributes$acti === void 0 ? void 0 : _this$attributes$acti.value) || _this.activeClass || 'active';
      _this.buttons = _this.querySelectorAll(((_this$attributes$butt = _this.attributes.button) === null || _this$attributes$butt === void 0 ? void 0 : _this$attributes$butt.value) || 'button.sandwich');
      _this.buttons.forEach(function (element) {
        element.addEventListener('click', function (event) {
          return _this._onClick(event);
        });
      });
      if (_this.attributes.target) {
        var _this$attributes$targ;
        _this.target = _this.querySelector(((_this$attributes$targ = _this.attributes.target) === null || _this$attributes$targ === void 0 ? void 0 : _this$attributes$targ.value) || '.content');
      }
      if (!_this.target) {
        var _this$attributes$targ2;
        _this.target = document.createElement('div');
        if ((_this$attributes$targ2 = _this.attributes.targetClass) !== null && _this$attributes$targ2 !== void 0 && _this$attributes$targ2.value) {
          _this.target.classList.add(_this.attributes.targetClass.value.split(" "));
        }
        _this.appendChild(_this.target);
      }
      _this.menu = _this.querySelector(((_this$attributes$menu = _this.attributes.menu) === null || _this$attributes$menu === void 0 ? void 0 : _this$attributes$menu.value) || 'ul.menu');
      if (!_this.menu) {
        var _this$attributes$menu2;
        _this.menu = document.createElement('ul');
        if ((_this$attributes$menu2 = _this.attributes.menuClass) !== null && _this$attributes$menu2 !== void 0 && _this$attributes$menu2.value) {
          _this.menu.classList.add(_this.attributes.menuClass.value.split(" "));
        }
        _this.appendChild(_this.menu);
      } else {
        _this.menu.querySelectorAll('li').forEach(function (element) {
          element.dataset.link = _this.buildPageUrl(element.innerHTML.toLowerCase());
          var idx = _this.items.push(element);
          element.addEventListener('click', function (event) {
            return _this._onClickMenuItem(idx - 1);
          });
        });
      }
      _this.createMenuItems();
      var userSelectedPage = _this.getMenuItemNumByUrl(_this.getPage());
      _this._onToggle(userSelectedPage !== undefined);
      _this.selectMenuItemNum(userSelectedPage !== null && userSelectedPage !== void 0 ? userSelectedPage : _this.defaultMenuItemNum);
      _this.updateQuery();
      return _this;
    }
    _createClass(Sandwich, [{
        ...
        if (this.attributes.items.value) {
          ...
          if (Array.isArray(items)) {
            var _loop = function _loop() {
              ...
              if (!li.dataset['link']) {
                li.dataset.link = _this2.buildPageUrl(li.innerHTML.toLowerCase());
              }
              _this2.menu.appendChild(li);
              var idx = _this2.items.push(li) - 1;
              li.addEventListener('click', function (event) {
                return _this2._onClickMenuItem(idx);
              });
              if (items[i]["default"] === true) {
                _this2.defaultMenuItemNum = idx;
              }
            };
            for (var i in items) {
              _loop();
      ...
      key: "_onLoadPage",
      value: function _onLoadPage(document, page, object) {
      ...
      value: function selectMenuItemNum(itemNum) {
        ...
        if (this.target) {
          fetch(page).then(function (response) {
            ...
            _this3.target.innerHTML = '';
            if (doc.body) {
              var docObj = _this3.target.appendChild(doc.body);
              //                    docObj.style.minHeight = docObj.scrollHeight+"px";
              _this3._onLoadPage(docObj, page, item);
            } else {
              _this3.target.innerHTML = 'Ressource ' + page + ' could not be loaded';
            }
          })["catch"](function (error) {
