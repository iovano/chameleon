...
(function () {
  ...
  var Gallery = /*#__PURE__*/function (_HTMLElement) {
    ...
    _createClass(Gallery, [{
      ...
      key: "_onMediaReady",
      value: function _onMediaReady(event) {
      ...
      key: "_onVideoLoad",
      value: function _onVideoLoad(event) {
        this.img[0].video = event.target;
      }
    }, {
      key: "_onVideoStart",
      value: function _onVideoStart(event) {
        this.dispatchEvent('MediaReady', event);
      }
    }, {
      key: "setProps",
      ...
      value: function createMediaElement() {
        ...
        if (cImage.media === 'video') {
          ...
          img.addEventListener('loadeddata', function (event) {
            return _this7.dispatchEvent('VideoLoad', event);
          });
          img.addEventListener('play', function (event) {
            return _this7.dispatchEvent('VideoStart', event);
          });
          img.addEventListener('canplaythrough', function (event) {
            return _this7.dispatchEvent('MediaReady', event);
          });
          ...
          img.addEventListener('load', function (event) {
            return _this7.dispatchEvent('ImageLoad', event);
          });
