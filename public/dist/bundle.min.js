...
(function () {
  ...
  var Sandwich = /*#__PURE__*/function (_HTMLElement) {
    ...
    function Sandwich() {
      var _this$attributes$butt, _this$attributes$menu;
      var _this;
    ...
    _createClass(Sandwich, [{
      ...
      key: "_onLoadPage",
      value: function _onLoadPage(document, url, object) {
      ...
      value: function selectMenuItemNum(itemNum) {
        ...
        (_this$items$this$sele = this.items[this.selectedMenuItemNum]) === null || _this$items$this$sele === void 0 ? void 0 : _this$items$this$sele.classList.remove('active');
