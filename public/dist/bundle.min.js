  ...
  var Swiper = /*#__PURE__*/function () {
    function Swiper(element) {
      ...
      this.element.addEventListener('touchstart', function (evt) {
        ...
        console.log("touchstart", evt.touches);
      }, false);
      this.element.addEventListener('touchmove', function (evt) {
        this.handleTouchMove(evt);
        console.log("touchend", evt.touches);
      }, false);
    }
    _createClass(Swiper, [{
      key: "onLeft",
  ...
  var Gallery = /*#__PURE__*/function (_HTMLElement) {
    ...
    function Gallery() {
      ...
      _defineProperty(_assertThisInitialized(_this), "listeners", {
        document: ['MouseMove', 'KeyUp', 'KeyDown', 'TouchStart', 'TouchEnd', 'TouchMove'],
    ...
    _createClass(Gallery, [{
            ...
            while (1) switch (_context.prev = _context.next) {
              case 0:
                ...
                return _context.abrupt("return", fetch(filename).then(function (response) {
                  ...
                  _this4.dispatchEvent('Error', undefined, error);
                }));
              case 2:
              case "end":
        ...
        if (value === true) {
          if (this.transitionFrame && !this.isPaused()) {
            this.afterTransition = function () {
              return _this5.dispatchEvent("PauseStart");
            };
      ...
      value: function showImage() {
        ...
        img.addEventListener("error", function (event) {
          return _this6.dispatchEvent('Error', event);
        });
      ...
      value: function createFilmStrip() {
        ...
        if (!this.filmstrip || forceRecreation) {
          ...
          this.filmStrip.onSelectImage = function (event, selectedImageNum, selectedAlbumNum) {
            _this7.navigate(selectedImageNum, selectedAlbumNum);
          };
        }
