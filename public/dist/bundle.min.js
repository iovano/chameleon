...
(function () {
  ...
  function start(newTheme) {
    ...
    if ((params === null || params === void 0 ? void 0 : params.debug) === 'screen') {
      var _debug = function _debug(event) {
      ...
      gallery.onEvent = function (event) {
        var p = ['suspended', 'transitionFrame', 'breakTimeFrame', 'currentImageNum', 'currentAlbumNum', 'userIdleTime'];
        ...
        for (var _len2 = arguments.length, props = new Array(_len2 > 1 ? _len2 - 1 : 0), _key3 = 1; _key3 < _len2; _key3++) {
          props[_key3 - 1] = arguments[_key3];
        }
        if (['Paused', 'Idle'].indexOf(event) === -1) _debug.apply(void 0, [event].concat(props));
      };
      console.log = function (message) {
        if (_typeof(message) == 'object') {
          _debug('log', JSON.stringify(message));
        } else {
          for (var _len3 = arguments.length, props = new Array(_len3 > 1 ? _len3 - 1 : 0), _key4 = 1; _key4 < _len3; _key4++) {
            props[_key4 - 1] = arguments[_key4];
          }
          _debug('log', message, JSON.stringify(props));
        }
      };
    }
