...
(function () {
  ...
  var Transitions = /*#__PURE__*/function (_Canvas) {
    ...
    function Transitions(albums) {
      ...
      _defineProperty(_assertThisInitialized(_this), "transitions", ['DotGain', 'Pipe', 'Grinder', 'Fader']);
    ...
    _createClass(Transitions, [{
      ...
      value: function transitionGrinder(canvas) {
        ...
        var grid = this.get('grid') === 'auto' ? grid = Math.floor(max / 10) + 1 : this.get('grid').x || this.get('grid');
  ...
  function start(newTheme) {
    var urlSearchParams = new URLSearchParams(window.location.search);
    var params = Object.fromEntries(urlSearchParams.entries());
    theme = newTheme || (params === null || params === void 0 ? void 0 : params.theme) || 'DotGain';
    window.theme = theme;
