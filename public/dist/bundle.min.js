...
(function () {
    ...
    _createClass(Star, [{
      ...
      value: function draw(_ref) {
        ...
        var _ref$canvas = _ref.canvas,
          canvas = _ref$canvas === void 0 ? undefined : _ref$canvas,
          ...
          innerRadius = _ref$innerRadius === void 0 ? 40 : _ref$innerRadius,
          _ref$numPoints = _ref.numPoints,
          numPoints = _ref$numPoints === void 0 ? 5 : _ref$numPoints,
        ...
        var centerX = (_position$x = position.x) !== null && _position$x !== void 0 ? _position$x : canvas.width / 2;
        var centerY = (_position$y = position.y) !== null && _position$y !== void 0 ? _position$y : canvas.height / 2;
    ...
    _createClass(FilmStrip, [{
      ...
      value: function createFilmStripItems(items) {
        ...
        var _loop = function _loop(i) {
          var _items$i, _items$i2, _items$i2$size, _items$i3;
          ...
          var media = (_items$i = items[i]) === null || _items$i === void 0 ? void 0 : _items$i.media;
          var img;
          if (media === 'video') {
          ...
          var sizes = (_items$i2 = items[i]) === null || _items$i2 === void 0 ? void 0 : (_items$i2$size = _items$i2.size) === null || _items$i2$size === void 0 ? void 0 : _items$i2$size[media];
  ...
  var FulltextSearch = /*#__PURE__*/function () {
    function FulltextSearch() {
      _classCallCheck(this, FulltextSearch);
    }
    _createClass(FulltextSearch, null, [{
      key: "matchAgainst",
      value: function matchAgainst(query, data) {
        function recursiveMatch(query, data) {
          var matches = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
          var score = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;
          function isObject(item) {
            return item instanceof Object || _typeof(item) == 'object';
          }
          ...
          if (isObject(data)) {
            for (var _i = 0, _Object$entries = Object.entries(data); _i < _Object$entries.length; _i++) {
              ...
              var _recursiveMatch = recursiveMatch(query, value, matches, score);
              var _recursiveMatch2 = _slicedToArray(_recursiveMatch, 2);
              matches = _recursiveMatch2[0];
              score = _recursiveMatch2[1];
            }
          } else if (isArray(data)) {
            for (var i = 0; i < data.length; i++) {
              var _recursiveMatch3 = recursiveMatch(query, data[i], matches, score);
              var _recursiveMatch4 = _slicedToArray(_recursiveMatch3, 2);
              matches = _recursiveMatch4[0];
              score = _recursiveMatch4[1];
            }
  ...
  var Gallery = /*#__PURE__*/function (_HTMLElement) {
    ...
    function Gallery() {
      ...
      _defineProperty(_assertThisInitialized(_this), "preferences", {
        ...
        videoStyle: (_videoStyle = {
          ...
          width: '100%',
          height: '100%'
        }, _defineProperty(_videoStyle, "top", 0), _defineProperty(_videoStyle, "left", 0), _defineProperty(_videoStyle, "alignment", {
          x: 0.5,
      ...
      _defineProperty(_assertThisInitialized(_this), "imageLayersMax", 2);
      ...
      _defineProperty(_assertThisInitialized(_this), "shufflePosition", 0);
      /* canvas elements */
    ...
    _createClass(Gallery, [{
      ...
      value: function set(key, value) {
        /* recursively set preferences (using dot-syntax) */
        ...
        var changeset = setProperty(this.preferences, key, value);
        this.preferences = changeset;
        return changeset;
      }
    }, {
      key: "importPreferences",
      value: function importPreferences(preferences) {
        var prefix = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'p.';
        var arraySuffix = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '[]';
        var arraySeparator = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : ',';
        if (!preferences) {
          return;
        }
        for (var _i = 0, _Object$entries = Object.entries(preferences); _i < _Object$entries.length; _i++) {
          var _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2),
      ...
      value: function navigate() {
        ...
        if (this.get('shuffle') == true && (targetImage === undefined || !(targetImage !== null && targetImage !== void 0 && targetImage.album) && !(targetImage !== null && targetImage !== void 0 && targetImage.image) && isNaN(targetImage) || (typeof targetImage === 'string' || targetImage instanceof String) && ["+", "-"].indexOf((targetImage || 0).substring(0, 1) !== -1))) {
        ...
        } else if (_typeof(targetImage) === 'object' || targetImage === undefined) {
      ...
      key: "setShufflePosition",
      value: function setShufflePosition() {
        var shufflePositionNum = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
        ...
        var photo = this.shuffleIndex[this.shufflePosition];
        this.setCurrentAlbumNum(photo.albumNum);
        this.setCurrentImageNum(photo.imageNum);
      }
    }, {
      key: "getShufflePosition",
      value: function getShufflePosition() {
      ...
      value: function getImageSrc(img) {
        ...
        var media = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : undefined;
        if (typeof img === 'string' || img instanceof String) {
          return img;
        }
        media = (_media = media) !== null && _media !== void 0 ? _media : img === null || img === void 0 ? void 0 : img.media;
        try {
          return (img === null || img === void 0 ? void 0 : img.src) || (img === null || img === void 0 ? void 0 : img.size[media][size]);
        } catch (error) {
      ...
      value: function updateOverlays() {
        for (var _i3 = 0, _Object$keys = Object.keys(this.overlays); _i3 < _Object$keys.length; _i3++) {
      ...
      value: function getFilteredResults() {
        ...
        var albums = arguments.length > 1 ? arguments[1] : undefined;
        albums = albums || this.loadedAlbums || this.albums;
        filters = _objectSpread2(_objectSpread2({}, this.get('filters')), filters);
        var filteredAlbums = [];
        var filteredPhotos = [];
        for (var a = 0; a < albums.length; a++) {
          ...
          for (var p = 0; p < albums[a].photos.length; p++) {
            ...
            var matches = 0;
            var score = 0;
            if (((_filters = filters) === null || _filters === void 0 ? void 0 : _filters.safety.indexOf(photo.safety)) !== -1) {
              matches = 1;
            }
            if (matches && (_filters2 = filters) !== null && _filters2 !== void 0 && _filters2.searchterm) {
              var _filters3;
              var _FulltextSearch$match = FulltextSearch.matchAgainst((_filters3 = filters) === null || _filters3 === void 0 ? void 0 : _filters3.searchterm, photo);
              var _FulltextSearch$match2 = _slicedToArray(_FulltextSearch$match, 2);
              matches = _FulltextSearch$match2[0];
              score = _FulltextSearch$match2[1];
            }
            if (matches) {
      ...
      value: function applyFilters() {
        var filters = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
        var albums = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
      ...
      key: "getShuffleIndex",
      value: function getShuffleIndex(index) {
        index = index || this.index;
        if (!index) {
          index = this.getIndex();
        }
        var shuffledIndex = index.sort(function (a, b) {
      ...
      key: "getIndex",
      value: function getIndex(albums) {
        var index = [];
      ...
      key: "_onLastTouch",
      value: function _onLastTouch(touch, event) {
      ...
      key: "togglePureMode",
      value: function togglePureMode() {
        var pureModeState = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : undefined;
      ...
      key: "_onVideoLoaded",
      value: function _onVideoLoaded(event) {
        this.img[0].video = event.target;
        this.dispatchEvent("VideoPlay", event);
      }
    }, {
      key: "_onVideoPlay",
      value: function _onVideoPlay(event) {
        var _event$target,
          _this7 = this;
        var video = (_event$target = event === null || event === void 0 ? void 0 : event.target) !== null && _event$target !== void 0 ? _event$target : this.img[0].video;
        if (video instanceof HTMLVideoElement && video.currentTime === 0) {
          video.play().then(function () {
            _this7.dispatchEvent("MediaReady");
          })["catch"](function (error) {
            _this7.dispatchEvent("RequireInteraction", video);
      ...
      value: function createMediaElement() {
        var _cImage,
          _this8 = this;
        var cImage = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : undefined;
        cImage = (_cImage = cImage) !== null && _cImage !== void 0 ? _cImage : this.getCurrentImage();
        var img;
        if (cImage.media === 'video') {
          img = document.createElement('video');
          img.addEventListener('loadeddata', function (event) {
            return _this8.dispatchEvent('VideoLoading', event);
          });
          img.addEventListener('play', function (event) {
            return _this8.dispatchEvent('MediaReady', event);
          });
          img.addEventListener('canplaythrough', function (event) {
            return _this8.dispatchEvent('VideoLoaded', event);
          });
          ...
          img.addEventListener('load', function (event) {
            return _this8.dispatchEvent('ImageLoad', event);
          });
        ...
        img.addEventListener("error", function (event) {
          return _this8.dispatchEvent('Error', event);
        });
        return img;
      }
    }, {
      ...
      value: function showImage() {
        ...
        var media = this.createMediaElement();
      ...
      key: "addImageLayer",
      value: function addImageLayer(imgLayer) {
      ...
      value: function createCanvasContainer() {
        var canvasElement = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'div';
      ...
      value: function createFilmStrip() {
        ...
        if (!this.filmstrip || forceRecreation) {
          ...
          this.filmStrip.onSelectImage = function (event, selectedImageNum, selectedAlbumNum) {
            _this9.navigate(selectedImageNum, selectedAlbumNum);
          };
        }
  ...
  var Canvas = /*#__PURE__*/function (_Gallery) {
    _inherits(Canvas, _Gallery);
    var _super = _createSuper(Canvas);
    function Canvas(albums) {
      _classCallCheck(this, Canvas);
      return _super.call(this, albums);
    }
    _createClass(Canvas, [{
      key: "drawImage",
      value: function drawImage(canvas, image) {
        var scale = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
        if (canvas instanceof HTMLCanvasElement) {
          var _image$videoHeight, _image$videoWidth;
          var context = canvas.getContext('2d');
          var width = this.canvasContainer.clientWidth;
          var height = this.canvasContainer.clientHeight;
          var style = this.get(image instanceof HTMLVideoElement ? 'videoStyle' : 'imgStyle');
          if (scale) {
            canvas.style.transform = "scale(" + scale + "," + scale + ")";
          }
          var imgh = (_image$videoHeight = image.videoHeight) !== null && _image$videoHeight !== void 0 ? _image$videoHeight : image.height;
          var imgw = (_image$videoWidth = image.videoWidth) !== null && _image$videoWidth !== void 0 ? _image$videoWidth : image.width;
      ...
      value: function _onTransitionEnd() {
        ...
        (_get2 = _get(_getPrototypeOf(Canvas.prototype), "_onTransitionEnd", this)).call.apply(_get2, [this].concat(props));
      }
    }, {
      key: "replaceCanvasWithDiv",
      value: function replaceCanvasWithDiv() {
        if (this.img[0] instanceof HTMLCanvasElement) {
          var _this$img$0$video;
          /* replace canvas with div once transition is done because native html image quality is superior to canvas image renderer */
          var div = document.createElement('div');
          var img = (_this$img$0$video = this.img[0].video) !== null && _this$img$0$video !== void 0 ? _this$img$0$video : this.img[0].image;
          var oldLayer = this.img[0];
          div.appendChild(img);
          div.image = img;
      ...
      value: function _onImageLoad(event) {
        ...
        if (typeof createImageBitmap === 'function') {
          createImageBitmap(image, {
            ...
            _this.img[0].bitmap = bitmap;
            _get(_getPrototypeOf(Canvas.prototype), "_onImageLoad", _this).call(_this, event);
            _this.drawImage(_this.img[0], bitmap);
          })["catch"](function (error) {
            _this.dispatchEvent('Error', error);
          });
        } else {
          _get(_getPrototypeOf(Canvas.prototype), "_onImageLoad", this).call(this, event);
          this.drawImage(this.img[0], image);
        }
      }
    }, {
      key: "showImage",
      value: function showImage(cImage, src) {
        ...
        */
        ...
        var image = this.createMediaElement();
      ...
      key: "createCanvasContainer",
      value: function createCanvasContainer() {
        _get(_getPrototypeOf(Canvas.prototype), "createCanvasContainer", this).call(this, 'div');
      }
    }]);
    return Canvas;
  }(Gallery);
  ...
  var Transitions = /*#__PURE__*/function (_Canvas) {
    _inherits(Transitions, _Canvas);
    var _super = _createSuper(Transitions);
    function Transitions(albums) {
      var _this;
      _classCallCheck(this, Transitions);
      _this = _super.call(this, albums);
      _defineProperty(_assertThisInitialized(_this), "transitions", ['DotGain', 'Pipe', 'Grinder', 'Fader', 'Star']);
    ...
    _createClass(Transitions, [{
      key: "transitionPipe",
      value: function transitionPipe(canvas) {
        var context = canvas.getContext('2d');
        context.beginPath();
        var r = this.transitionFrame * Math.max(canvas.width, canvas.height) / this.get('transitionDuration') / this.get('fps') + this.get('transitionEase', 1) * this.transitionFrame * this.transitionFrame;
      ...
      key: "transitionStar",
      value: function transitionStar(canvas) {
        var star = new Star(canvas);
        var r = Math.max(canvas.width, canvas.height) * this.get('transitionDuration') / this.get('fps') * this.transitionFrame / 2;
        star.draw({
          outerRadius: r,
          innerRadius: r / 2,
      ...
      key: "transitionGrinder",
      value: function transitionGrinder(canvas) {
        var context = canvas.getContext('2d');
        var max = Math.max(canvas.height, canvas.width) * 2;
        var grid = this.get('grid') === 'auto' ? grid = Math.floor(max / 30) + 1 : this.get('grid').x || this.get('grid');
        var cols = grid ? max / grid : 0;
        context.translate(canvas.width / 2, canvas.height / 2);
        context.rotate(this.get('currentDirection') * Math.PI / 180);
        context.beginPath();
        var h = this.transitionFrame * max / this.get('transitionDuration') / this.get('fps');
      ...
      key: "transitionDotGain",
      value: function transitionDotGain(canvas) {
        function calculateDistance(x1, y1, x2, y2) {
          var distance = ~~Math.sqrt(Math.pow(x2 - x1, 2) + Math.pow(y2 - y1, 2));
          return distance;
        }
        var context = canvas.getContext('2d');
        var max = Math.max(canvas.height, canvas.width);
        context.beginPath();
        if (this.transitionFrame === 1 || !this.preferences.origin) {
          var a = Math.floor(Math.random() * 4);
          this.preferences.origin = {
            x: a == 0 || a == 2 ? canvas.width * Math.random() : a == 3 ? canvas.width : 0,
            y: a == 1 || a == 3 ? canvas.height * Math.random() : a == 2 ? canvas.height : 0
          };
        }
        var grid;
        if (this.get('grid') === 'auto') {
          ...
          grid = {
            x: this.get('grid').x || this.get('grid', max / 30),
            y: this.get('grid').y || this.get('grid', max / 30)
          };
        }
        var pending = 0;
        for (var x = 0; x <= canvas.width / grid.x + 1; x += 1) {
          for (var y = 0; y <= canvas.height / grid.y + 1; y += 1) {
            context.moveTo(0, 0);
            var r = -calculateDistance(x * grid.x, y * grid.y, this.preferences.origin.x, this.preferences.origin.y) * this.get('transitionDuration') / this.get('fps') / 2 + this.get('transitionEase', 0) * this.transitionFrame + this.transitionFrame / this.get('fps') * Math.abs(grid.x, grid.y);
      ...
      value: function _onTransitionStart() {
        ...
        _get(_getPrototypeOf(Transitions.prototype), "_onTransitionStart", this).call(this);
      }
    }, {
      key: "updateClipPathTransition",
      value: function updateClipPathTransition() {
        if (this.currentTransition === 'Fader') {
          ...
          return _get(_getPrototypeOf(Transitions.prototype), "updateClipPathTransition", this).call(this);
        }
        for (var i = 0; i < this.img.length; i++) {
          var canvas = this.img[i];
          var scale = 1 + canvas.frame * this.get('zoomspeed', 0) / 1000 / this.get('fps');
          ...
          if (canvas instanceof HTMLCanvasElement) {
            ...
            if (i === 0) {
              var _ref, _canvas$video;
              context.clearRect(0, 0, canvas.width, canvas.height);
              context.fillStyle = "#000";
              context.fillRect(0, 0, canvas.width, canvas.height);
              this.drawImage(canvas, (_ref = (_canvas$video = canvas.video) !== null && _canvas$video !== void 0 ? _canvas$video : canvas.bitmap) !== null && _ref !== void 0 ? _ref : canvas.image, scale);
  ...
  var Debugger = /*#__PURE__*/function (_HTMLElement) {
    _inherits(Debugger, _HTMLElement);
    var _super = _createSuper(Debugger);
    function Debugger(context) {
      var _this;
      var watchListeners = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
      var watchProperties = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
      var ignoreEvents = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : [];
      _classCallCheck(this, Debugger);
      _this = _super.call(this);
      _defineProperty(_assertThisInitialized(_this), "lastMessage", void 0);
      _defineProperty(_assertThisInitialized(_this), "keepEventsNum", 50);
      _defineProperty(_assertThisInitialized(_this), "repetitions", 0);
      _defineProperty(_assertThisInitialized(_this), "skipRedundantMessages", true);
      _defineProperty(_assertThisInitialized(_this), "debugContainer", void 0);
      _defineProperty(_assertThisInitialized(_this), "debugHeader", void 0);
      _defineProperty(_assertThisInitialized(_this), "debugContent", void 0);
      _defineProperty(_assertThisInitialized(_this), "context", void 0);
      _this.context = context;
      _this.watchProperties = watchProperties;
      _this.watchListeners = watchListeners;
      _this.ignoreEvents = ignoreEvents;
    ...
    _createClass(Debugger, [{
      ...
      value: function addWatchers() {
        var _this2 = this;
        for (var i = 0; i < this.watchListeners.length; i++) {
          var listener = this.watchListeners[i];
          this.context[listener] = function (event) {
            for (var _len2 = arguments.length, props = new Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++) {
              props[_key2 - 1] = arguments[_key2];
            }
            _this2.onWatch.apply(_this2, [event].concat(props));
          };
        }
      }
    }, {
      key: "onWatch",
      value: function onWatch(event) {
        var p = this.watchProperties;
        ...
        if (this.ignoreEvents.indexOf(event) === -1) this.debug.apply(this, [event].concat(props));
      }
    }, {
      key: "cutOff",
      ...
      key: "debug",
      value: function debug(event) {
        var target = this.debugContent;
        var atBottom = target.scrollHeight - target.scrollTop - target.clientHeight < 1;
        if (this.skipRedundantMessages) {
          if (event === this.lastMessage) {
            ...
            _span.classList.add("repetitions");
            _span.innerHTML = ".." + this.repetitions + "x ";
            target.appendChild(_span);
          }
        }
        this.repetitions = 0;
        var div = document.createElement('div');
  ...
  var Search = /*#__PURE__*/function (_HTMLElement) {
    ...
    function Search() {
      ...
      _this = _super.call(this);
      _defineProperty(_assertThisInitialized(_this), "searchterm", void 0);
      ...
      _this.input.addEventListener('focus', function (event) {
        return _this._onFocus(event);
      });
      _this.input.addEventListener('blur', function (event) {
  ...
  window.onSubmitSettings = function (event, form) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        if (_key.substring(_key.length - 2) === '[]') {
  ...
  function start() {
    ...
    if ((params === null || params === void 0 ? void 0 : params.debug) === 'screen') {
      var debug = new Debugger(gallery, ['onEvent'], ['suspended', 'transitionFrame', 'breakTimeFrame', 'currentImageNum', 'currentAlbumNum', 'userIdleTime'], ['Paused', 'Idle', 'MouseMove']);
    ...
    if ((params === null || params === void 0 ? void 0 : params.order) === 'shuffle') {
      gallery.setShuffleMode(true);
    }
    function updateSearchResults(searchterm) {
      var results = gallery.getFilteredResults({
        searchterm: searchterm
      });
      search.querySelectorAll('.searchResults').forEach(function (el) {
    ...
    if (firstRun) {
      ...
      var icon = search.querySelector('.icon');
